    ...
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="lg:w-1/2 mb-12 lg:mb-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/create-cv" className="btn-secondary text-lg px-8 py-4">
                  Improve my CV
                </Link>
                <Link href="/create-cv" className="btn-primary text-lg px-8 py-4 shimmer">
                  Create new CV
                </Link>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-teal-500 to-teal-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/create-cv" className="bg-white text-teal-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-block">
